		...
		<form name="form1" method="post" action="">
			<div class="card">
				<div class="card-block">
					...
					<!--Blue select-->
					<div class="md-form">
						<select class="mdb-select colorful-select dropdown-primary" name="lp" id="lp">
					...
					<div class="md-form">
						<input placeholder="Selected date" type="text" id="datepicker3" class="form-control datepicker" name="tglr">
						<label for="datepicker3">Cari tanggal : </label>
					</div>

					<div class="md-form">
						<input placeholder="Selected date" type="text" id="datepicker2" class="form-control datepicker" name="tglr2">
						<label for="datepicker2">Hingga : </label>
					</div>

					<div class="text-xs-center">
						<button type="submit" name="submit" class="btn btn-deep-purple">Cari</button>
					</div>
